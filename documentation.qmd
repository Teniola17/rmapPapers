...
These are combined across studies using MAP to get the $MAP$ prior. And can be converted to a mixture of conjugate distributions using`automixfit` function from the `RBesT` package.
